...
//        if(ObjectUtils.isEmpty(pm.getIntent())){
//            JsonObject jsonObject = new JsonObject();
//            //jsonObject.addProperty("url","intent:#Intent;action=android.intent.action.MAIN;end");
////            jsonObject.addProperty("url","intent:#Intent;action=com.zmu.cloud.zmuaction;component=com.zm.cloud/com.zm.cloud.ui.MainActivity;S.key1=value;i.key2=2;end");
//            pm.setIntent(jsonObject);
//        }
        ...
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder().setAlert(StringUtils.trim(pm.getContent()))
                        ...
                        .addPlatformNotification(AndroidNotification.newBuilder().setTitle(pm.getTitle()).setIntent(pm.getIntent()).setBuilderId(1).setPriority(pm.getPriority() != null ? pm.getPriority() : 0).addExtras(pm.getExtras()).build()).build()
                ).build();
