...
public class MeasureStartDelayQueue {
    ...
    private void initDelayQueue() {
        blockingQueue = redis.getBlockingQueue(CacheKey.Queue.measureStart.type);
    ...
    public void offer(Long logId) {
        delayedQueue.offer(logId, CacheKey.Queue.measureStart.duration.getSeconds(), TimeUnit.SECONDS);
    }
